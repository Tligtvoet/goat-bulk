...
public:
    ...
    void setupUi(QWidget *EmployeeManager)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(50, 40, 301, 51));
        ...
        verticalLayoutWidget->setGeometry(QRect(150, 120, 211, 111));
        ...
        verticalLayoutWidget_2->setGeometry(QRect(10, 120, 133, 141));
        ...
        horizontalLayoutWidget->setGeometry(QRect(151, 239, 209, 24));
